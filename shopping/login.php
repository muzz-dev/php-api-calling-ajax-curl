...
<body>
	...
	<div style="align-items:center">
		<center>
			<h4>Login to Continue as Customer</h4>
			<form method="POST">
				<?php

				if(isset($_REQUEST["btnLogin"])){
					$result = mysqli_query($conn,"select * from user where phone='".$_REQUEST['txtUsername']."' and password = '".$_REQUEST['txtPassword']."'");
				...
				<a href="index.php" class="auth-link text-black">Login as a Admin?</a>
			</form>
		</center>
	</div>
</body>
